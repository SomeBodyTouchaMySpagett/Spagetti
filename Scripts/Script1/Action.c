...
/*Correlation comment - Do not change!  Original value='128385.84236533zzADitzpHzzzzzzHDQzcDpAiAz' Name ='userSession' Type ='ResponseBased'*/
	...
	lr_end_transaction("0_transaction_Script_1",LR_AUTO);
