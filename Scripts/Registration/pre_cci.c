# 1 "c:\\users\\armaev\\documents\\vugen\\scripts\\registration\\\\combined_Registration.c"
...
# 1 "c:\\users\\armaev\\documents\\vugen\\scripts\\registration\\\\combined_Registration.c" 2
...
# 2 "c:\\users\\armaev\\documents\\vugen\\scripts\\registration\\\\combined_Registration.c" 2
...
# 3 "c:\\users\\armaev\\documents\\vugen\\scripts\\registration\\\\combined_Registration.c" 2
...
# 4 "c:\\users\\armaev\\documents\\vugen\\scripts\\registration\\\\combined_Registration.c" 2
...
Action()
{
	...
	lr_end_transaction("1_transaction_Sign_Up",2);
	...
	lr_end_transaction("1_transaction_Enter",2);
	
	lr_think_time(5);

	lr_start_transaction("1_transaction_Continue");
	
	lr_end_transaction("1_transaction_Continue",2);
	
	lr_think_time(5);

	lr_start_transaction("1_transaction_Exit");

	lr_end_transaction("1_transaction_Exit",2);
	
	lr_end_transaction("1_transaction_Reg", 2);

	return 0;
}
# 5 "c:\\users\\armaev\\documents\\vugen\\scripts\\registration\\\\combined_Registration.c" 2
...
# 6 "c:\\users\\armaev\\documents\\vugen\\scripts\\registration\\\\combined_Registration.c" 2
